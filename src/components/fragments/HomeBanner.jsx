...
const HomeBanner = (props) => {
    ...
    return (
        <div className={`h-80 md:h-screen bg-center bg-cover bg-no-repeat p-5`} style={{backgroundImage: `url(/images/information-outline.png)`}}>
            <div className="h-full flex flex-col justify-end w-full p-5">
                ...
                <div className="flex justify-between mt-5">
                    <div className="flex gap-2">
                        ...
                        <Button color="slate-500" width="fit" imageUrl="/images/information-outline.png">Selengkapnya</Button>
